...
streamer = Streamer(bucket_name="Example Performance Metrics",bucket_key="macbook_air", buffer_size=100, ini_file_location="./isstreamer.ini", debug_level=2)

sample_rate_in_ms=5000
